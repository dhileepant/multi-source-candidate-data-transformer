        ...
        profiles.forEach((profile, index) => {
            ...
            if (profile.skills && profile.skills.length > 0) {
                ...
                skillsHtml = `
                    <div class="skills-tags" id="skills-${index}">
                        ${first8.map(s => `<span class="skill-tag">${s}</span>`).join('')}
                        ...
                        <span id="more-skills-${index}" style="display:none;">
                            ${rest.map(s => `<span class="skill-tag">${s}</span>`).join('')}
                        </span>
                    </div>
                `;
            }
            ...
            card.innerHTML = `
                <div class="card-header">
                    ...
                    <div class="email">${profile.primary_email || profile.candidate_id}</div>
                </div>
